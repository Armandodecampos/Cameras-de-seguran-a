...
class CentralMonitoramento(ctk.CTk):
    ...
    def sobrescrever_predefinicao(self, nome):
        self.abrir_modal_confirmacao("Confirmar", f"Deseja sobrescrevê-la com a configuração atual?",
    ...
    def deletar_predefinicao(self, nome):
        self.abrir_modal_confirmacao("Confirmar", f"Deseja realmente excluí-la?",
