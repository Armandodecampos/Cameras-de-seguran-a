...
class CentralMonitoramento(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.slot_ctk_images = [None] * 16
        # Cache de estado da UI para evitar chamadas redundantes ao Tcl/Tk
        self.cache_ui_text = [None] * 16
        self.cache_ui_image = [None] * 16
        self.cache_ui_size = [None] * 16
    ...
    def entrar_tela_cheia(self):
        ...
        indices_visiveis = [self.slot_maximized] if self.slot_maximized is not None else range(16)
    ...
    def ao_soltar_slot(self, event, index):
        ...
        try:
            ...
            if 0 <= source_idx < 16 and 0 <= target_idx < 16:
            ...
            try:
                with open(self.arquivo_grid, "r", encoding='utf-8') as f:
                    ...
                    if isinstance(dados, list):
                        for i in range(min(len(dados), 16)):
    ...
    def loop_exibicao(self):
        try:
            ...
            indices_trabalho = [self.slot_maximized] if self.slot_maximized is not None else range(16)
