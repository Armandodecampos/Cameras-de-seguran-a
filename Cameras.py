...
class CentralMonitoramento(ctk.CTk):
    ...
    def atribuir_ip_ao_slot(self, idx, ip, atualizar_ui=True, gerenciar_conexoes=True, salvar=True, forcado=False):
        ...
        # Otimização: se for o mesmo IP já presente no slot, não faz nada (a menos que seja forçado ou IP 0.0.0.0)
    ...
    def aplicar_predefinicao(self, nome):
        ...
        for i in range(20):
            ...
            # Atualiza visualmente cada slot de forma segura, sem salvar a cada iteração
        ...
        ips_novos_set = set(ip for ip in self.grid_cameras if ip and ip != "0.0.0.0")
