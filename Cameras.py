...
class CentralMonitoramento(ctk.CTk):
    ...
    def ao_arrastar_divisor(self, event):
        ...
        if 200 < nova_largura < 800:
            ...
            # Atualiza wraplength dos labels de presets
    ...
    def atualizar_lista_presets_ui(self):
        ...
        wrap = max(50, self.sidebar.winfo_width() - 120)
        ...
        for nome in presets:
            ...
            lbl = ctk.CTkLabel(frm, text=nome, font=("Roboto", 14), anchor="w", wraplength=wrap, cursor="hand2")
